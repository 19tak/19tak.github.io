 ...
 */
function copyLink(t) {
  (t && 0 !== t.length) || (t = window.location.href);
  const e = $("<input>");
  $("body").append(e),
    e.val(t).select(),
...
$(function () {
      ...
      c.on("keyup", function (t) {
        8 === t.keyCode && "" === c.val()
          ...
          : "" !== c.val() &&
            ...
            f() && d.addClass("unloaded"));
      }),
      a.on("click", function () {
        c.val(""),
          f() ? (d.removeClass("unloaded"), i.empty()) : p.off(),
          c.focus(),
          a.removeClass("visible");
      });
  }),
      ...
      setInterval(function () {
        n &&
          ((function () {
            ...
            Math.abs(l - t) <= 5 ||
              (t > l && t > r
                ? (e.removeClass("topbar-down").addClass("topbar-up"),
                  0 < o.length && o.removeClass("topbar-down"),
                  0 < a.length && a.removeClass("topbar-down"),
                  s.is(":focus") && s.blur())
                : t + $(window).height() < $(document).height() &&
                  (e.removeClass("topbar-up").addClass("topbar-down"),
                  0 < o.length && o.addClass("topbar-down"),
                  0 < a.length && a.addClass("topbar-down")),
              (l = t));
          })(),
          (n = !1));
      }, 250);
  ...
  $(function () {
    const t = $("#topbar-title"),
      e = $("div.post>h1"),
      o = t.text().trim();
    let a = (0 < e.length ? e : $("h1")).text().trim();
  ...
  $(function () {
    let s = $(".timeago").length,
      t = void 0;
    function e() {
      return (
        $(".timeago").each(function () {
          if (0 < $(this).children("i").length) {
              ...
              (function (t, e) {
                ...
                return (
                  ...
                  a.getFullYear() !== o.getFullYear()
                    ...
                    : ((e = Math.floor((o - a) / 1e3)),
                      1 <= (t = Math.floor(e / 86400))
                        ? (--s, t + " day" + (1 < t ? "s" : "") + " ago")
                        : 1 <= (t = Math.floor(e / 3600))
                        ? t + " hour" + (1 < t ? "s" : "") + " ago"
                        : 1 <= (e = Math.floor(e / 60))
                        ? e + " minute" + (1 < e ? "s" : "") + " ago"
                        : "just now")
        ...
        0 === s && void 0 !== t && clearInterval(t),
        s
      );
    }
    0 !== s && 0 < e() && (t = setInterval(e, 6e4));
  }),
  $(function () {
    const e = "language-",
      o = new RegExp(`^${e}([a-z])+$`);
    $(`div[class^=${e}`).each(function () {
      let t = $(this).attr("class").split(" ");
      t.forEach((t) => {
        o.test(t) &&
          ((t = t.substring(e.length)), $(this).attr("lang", `${t}`));
      });
    });
  }),
  $(function () {
    ...
    $("a[href*='#']")
      ...
      .click(function (e) {
        if (
          ...
          const l = decodeURI(this.hash);
          let o = RegExp(/^#fnref:/).test(l),
            a = RegExp(/^#fn:/).test(l);
          var n = l.includes(":") ? l.replace(/\:/, "\\:") : l;
          let s = $(n);
          if (s.length) {
            e.preventDefault(),
              history.pushState && history.pushState(null, null, l);
            n = $(this).offset().top;
            let t = s.offset().top;
            (e = t < n), (n = $("#topbar-wrapper").outerHeight());
            e && o && (t -= n + 8),
              $("html,body").animate({ scrollTop: t }, 800, () => {
                ...
                var e = "scroll-focus";
                if (
                  ($(`[${e}=true]`).length && $(`[${e}=true]`).attr(e, !1),
                  $(":target").length && $(":target").attr(e, !1),
                  (a || o) && t.attr(e, !0),
                  t.is(":focus"))
                )
                  return !1;
...
$(document).ready(function () {
  ...
  if ($.browser.name != "chrome") {
    ...
    function userReplace(str) {
      return str
        .replace(/^#/gi, "<root>[root@localhost]# </root>")
        .replace(/^\$/gi, "<user>[user@localhost]$ </user>");
    }
  }
